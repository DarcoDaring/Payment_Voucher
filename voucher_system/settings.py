...
Production-ready for Railway.app (HTTPS, SQLite, Secure Cookies, No Redirect Loop)
"""
...
if RAILWAY_STATIC_URL:
    # e.g., https://paymentvoucher-production-d63d.up.railway.app → paymentvoucher-production-d63d.up.railway.app
